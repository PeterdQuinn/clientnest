...
const Sidebar = () => {
  return (
    <div style={{ width: '16rem', height: '100%', backgroundColor: 'white', borderRight: '1px solid #e5e7eb', padding: '1rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div style={{ border: '1px solid #e5e7eb', padding: '1rem', borderRadius: '0.5rem' }}>
          ...
          <div className="progress-bar" style={{ marginBottom: '0.5rem' }}>
            <div className="progress-bar-fill" style={{ width: '80%', backgroundColor: '#3b82f6' }}></div>
          </div>
        ...
        <div style={{ border: '1px solid #e5e7eb', padding: '1rem', borderRadius: '0.5rem' }}>
          ...
          <div className="progress-bar" style={{ marginBottom: '0.5rem' }}>
            <div className="progress-bar-fill" style={{ width: '100%', backgroundColor: '#10b981' }}></div>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.875rem', color: '#6b7280' }}>
  ...
  return (
    <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '0.5rem', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        <div className="message-card message-dev">
        ...
        <div className="message-card message-client">
      ...
      <div style={{ marginTop: '1rem', display: 'flex' }}>
        <input type="text" style={{ flexGrow: 1, borderTopLeftRadius: '0.5rem', borderBottomLeftRadius: '0.5rem', borderWidth: '1px', borderColor: '#d1d5db', padding: '0.5rem', fontSize: '0.875rem' }} placeholder="Type a message..." />
        <button style={{ backgroundColor: '#2563eb', color: 'white', borderTopRightRadius: '0.5rem', borderBottomRightRadius: '0.5rem', padding: '0 1rem' }}>Send</button>
      </div>
    </div>
  );
};
    ...
    <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '0.5rem', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        <div className="file-card">
          <div style={{ backgroundColor: '#dbeafe', color: '#1e40af', padding: '0.5rem', borderRadius: '0.5rem', marginRight: '0.75rem' }}>
          ...
          <a href="#" style={{ fontSize: '0.875rem', color: '#2563eb' }}>Download</a>
        </div>
        
        <div className="file-card">
          <div style={{ backgroundColor: '#fee2e2', color: '#b91c1c', padding: '0.5rem', borderRadius: '0.5rem', marginRight: '0.75rem' }}>
            <svg style={{ width: '1.25rem', height: '1.25rem' }} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
              <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.96 2.96 0 0 0 .13 5H5Z"/>
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: '1', padding: '1.5rem', backgroundColor: '#f3f4f6', overflow: 'auto' }}>
